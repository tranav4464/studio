          ...
          <div className="flex flex-col items-center justify-center space-y-10 text-center">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {features.map((feature, index) => (
                <div key={index} className="flex flex-col items-center space-y-4 p-6 bg-background rounded-lg shadow-md transition-all duration-200 ease-in-out hover:scale-[1.03] hover:shadow-lg text-center">
                  {feature.icon}
